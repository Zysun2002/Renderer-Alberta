...
class Gouraud_Shader():
    ...
    def fragment(self, bar):
        ...
        ambient = self.material['Ka'] if 'Ka' in self.material.keys() else 20
        ...
        ns = self.material['Ns'] if 'Ns' in self.material.keys() else 20
...
def main():
    ...
    eye = np.array((0, -65, -200))
    center = np.array((0, -67, -198))
    up = np.array((0,-1,-1))
