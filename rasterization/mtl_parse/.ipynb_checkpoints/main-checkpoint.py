...
class Gouraud_Shader():
    def __init__(self, model, args, light_dir, viewport, projection, model_view, view):
        self.model = model
        self.args = args
    ...
    def fragment(self, bar):
        ...
        color = args.ratio_Ka * ambient + args.ratio_Kd * diffuse + args.ratio_Ks * specular
...
def main(args):
    ...
    obj_path = "/root/autodl-tmp/tiny-renderer/assets/car/bugatti.obj"
    model = Model(obj_path)
    mtl_path = "/root/autodl-tmp/tiny-renderer/assets/car/bugatti.mtl"
    ...
    shader = Gouraud_Shader(model, args, light_dir, viewport, projection, model_view, view)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ratio_Ka', type=float, default=0.2)
    parser.add_argument('--ratio_Kd', type=float, default=0.9)
    parser.add_argument('--ratio_Ks', type=float, default=0.8)
