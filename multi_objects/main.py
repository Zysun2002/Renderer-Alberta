...
class Model():
    def __init__(self, obj_path):
        ...
        for name, geometry in scene.geometry.items():
            ...
            self.v_normals.append(normals)

            faces = faces + index_offset
        ...
        self.v_normals = np.vstack(self.v_normals)
...
class Gouraud_Shader():
    ...
    def fragment(self, bar):
        ...
        # color = self.model.retrieve_texture(uv[0], uv[1])
        color = (255, 255, 255)
...
def main():
    ...
    obj_path = "/root/autodl-tmp/tiny-renderer/assets/moved_eye.stl"
    ...
    for idx, face in tqdm(enumerate(model.faces)):
        ...
        if idx % 1000 == 0:
            image0 = image.transpose(Image.FLIP_TOP_BOTTOM)
            image0.save("real-time.png")
