...
from groups import norm, Model, embed_v, embed_vec
...
class Gouraud_Shader():
    ...
    def fragment(self, bar):
        ...
        # normal = norm((np.linalg.inv(self.projection @ self.model_view) @ \
        #     embed_v(self.model.retrieve_normal(uv[0], uv[1])))[:3])
